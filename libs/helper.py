...
def show_messages(current_chat: str, messages: list):
    ...
    for each in messages:
        ...
        if idr is not False:
            ...
            if "open_text_toolkit_value" not in sl.session_state or sl.session_state["open_text_toolkit_value"]:
                sl.session_state['delete_dict'][current_chat + ">" + str(idr)] = text_toolkit(
...
@sl.cache_data(max_entries=20, show_spinner=False)
