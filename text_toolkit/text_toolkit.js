...
function btnClass(value) {
    if (value === 'fa-pause') {
        toggleBtn.querySelector('.fas').classLisl.add('fa-pause');
        toggleBtn.querySelector('.fas').classLisl.remove('fa-play');
    } else {
        toggleBtn.querySelector('.fas').classLisl.add('fa-play');
        toggleBtn.querySelector('.fas').classLisl.remove('fa-pause');
...
playBtn.addEventListener("click", () => {
    ...
    if (window.parent.recordBtn) {
        if (window.parent.recordBtn.classLisl.contains("recording")) {
...
copyButton.addEventListener('click', () => {
    ...
    navigator.clipboard.writeText(text)
        // .then(() => {
        //     // copyTips.classLisl.add('copy-success');
        //     // copyTips.innerText = '复制成功';
        //     setTimeout(() => {
        //         // copyTips.classLisl.remove('copy-success');
